...
**État global (2026-09-23)** : sprints 0 à 11 **livrés** (v0.12.0) ; 48/50 exemples officiels compilent ; reste la validation sur carte réelle (S7-5, matériel requis) et les idées non planifiées. Cadrage : `docs/adr/ADR-001`.
...
## Sprint 8 — Performance, compléments, livraison (v0.9.0) — FAIT
...
## Sprint 11 — Différentiel aléatoire (v0.12.0) — FAIT

| ID    | Épop. | Récit utilisateur                                                                 | Prio | État |
|-------|-------|------------------------------------------------------------------------------------|------|------|
| S11-1 | E5    | `make fuzz` : programmes tirés au sort dans une grammaire sûre, interprétés et compilés, écrans comparés — 700 programmes vérifiés | P2   | FAIT |
