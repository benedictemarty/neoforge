...
> État : **sprint 11 livré (v0.12.0)** — éditeur à onglets + aide, émulateur Trinity dans la page, tokeniseur/
...
> Atic Atac compris ; **700 programmes tirés au sort** vérifiés de la même façon, `make fuzz`), **éditeur de sprites, tuiles et tilemaps** (`docs/GRAPHICS.md`),
