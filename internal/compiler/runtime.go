...
var rtDeps = map[string][]string{
	...
	"ERRSTRUCT": {"PUSH", "POPACC", "PRSTR", "PRINT", "PRCHR"}, "ERRTYPE": {"PUSH", "POPACC", "PRSTR", "PRINT", "PRCHR"},
...
var rtOrder = []string{"API", "MATH", "ACC2R1", "TMP2R1", "ACC2R2", "R12ACC", "PUSH", "POP", "POPACC", "LPUSH", "LPOP", "TMPTOACC", "NEG", "NOT", "ABS", "SGN", "BOOLEQ", "BOOLNE",
	...
	"TURTLEINIT", "TURTLEDELAY", "FWRITELINE", "FREADLINE", "ERRFILE", "ERRRANGE", "ERRDIV", "ERRDATA", "ERRMEM", "ERRSTR", "ERRSTRUCT", "ERRTYPE", "LDV", "STV", "LDT", "LDI8", "LTI8", "ADD32", "SUB32"}
...
func (g *gen) emitRoutine(name string) {
	...
	case "TURTLEINIT", "TURTLEDELAY", "FWRITELINE", "FREADLINE":
		...
		return
	case "ERRFILE", "ERRRANGE", "ERRDIV", "ERRDATA", "ERRMEM", "ERRSTR", "ERRSTRUCT", "ERRTYPE":
